...
//	public var showingURLQuestion:Boolean=false;
...
//		primTable['openURLDialog']        = primOpenURL;
...
/*	private function primOpenURL(b:Block):void {
		if (showingURLQuestion) {
			interp.doYield();
			return;
		}
		var obj:ScratchObj = interp.targetObj();
		if (interp.activeThread.firstTime) {
			var openURL:String = interp.arg(b, 0);
			showingURLQuestion=true;
			app.runtime.showURLQuestion(openURL);
			interp.activeThread.firstTime = false;
			interp.doYield();
		}
	}
	public function URLCancel():void{showingURLQuestion=false;}*/
