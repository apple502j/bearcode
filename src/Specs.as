...
//		["open url %s",                         " ", 107, "openURLDialog",        ""],
		...
		["join3 %s %s %s",	"r", 8, "concatenate2:with:",	"hello ", "scratch ", "world"],
		...
		["hide all sprites",					" ", 99, "hideAll"], // I added it in Looks
