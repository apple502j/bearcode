...
/*
	public function showURLQuestion(openURL:String):void {
		var d:DialogBox = new DialogBox(doNothing,(new SensingPrims(app,interp)).URLCancel);
        if(!useUnsafe)  return;
		d.addTitle('Warning');
		d.addWidget(new URLQuestion(openURL));
	...
	public function aboutDialog():void {
	    var d:DialogBox = new DialogBox();
	    d.addTitle('About');
	    d.addWidget(new About());
		d.addButton('Close', d.cancel);
		d.showOnStage(app.stage, true);
	}
